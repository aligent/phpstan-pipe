...
class PHPStan(Pipe):
    ...
    def upload_report(self):
        ...
        self.log_debug("bitbucket_workspace: ", bitbucket_workspace)
        self.log_debug("bitbucket_repo_slug: ", bitbucket_repo_slug)
        self.log_debug("bitbucket_commit: ", bitbucket_commit)
        self.log_debug("bitbucket_step_uuid: ", bitbucket_step_uuid)
        self.log_debug("bitbucket_pipeline_uuid: ", bitbucket_pipeline_uuid)
        self.log_debug("link: ", f"\"text\": \"Link text here\", \"href\":\"https://bitbucket.org/{self.bitbucket_workspace}/{self.bitbucket_repo_slug}/addon/pipelines/home#!/results/{self.bitbucket_pipeline_uuid}/steps/{self.bitbucket_step_uuid}/test-report\"")
